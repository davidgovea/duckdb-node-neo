...
export function prepared_statement_column_name(prepared_statement: PreparedStatement, col_idx: number): string;
...
export function prepared_statement_column_type(prepared_statement: PreparedStatement, col_idx: number): Type;
...
export function prepared_statement_column_logical_type(prepared_statement: PreparedStatement, col_idx: number): LogicalType;
